        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "02174cf0�9412�4cfe - afbf - 59f706d72cf6", 0, "28651d38-6e99-4a4d-826d-2db51a940deb", "admin@gmail.com", true, false, null, null, null, "AQAAAAEAACcQAAAAEAmQLVleo1P6N+0yVQYkMeuk6kHVjId0un1YfoAwM4eTj5N7sWFtxTEdZtZj8+nz5Q==", null, false, "2388c4c4-38b0-4d0c-affe-614fc73eeec2", false, "Admin" });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "Birthdate", "CreatedDate", "Email", "IsAdmin", "Name", "Password", "UpdatedDate" },
                values: new object[] { -1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 12, 6, 0, 14, 13, 808, DateTimeKind.Local).AddTicks(4825), "admin@admin.com", true, "Admin", "AQAAAAEAACcQAAAAEIaDsPqrMs86zZdS0saRtqLQ/wyflnp+Jr4gqFAhy6B5S3Qxij5owGXgYUT21jhAOA==", new DateTime(2021, 12, 6, 0, 14, 13, 808, DateTimeKind.Local).AddTicks(4825) });
